...
public class Client {
    ...
    public void client(String bottomBorder, String topBorder, String step){
        ...
        BufferedWriter writer = new BufferedWriter( new OutputStreamWriter(clientSocket .getOutputStream()));
            ...
            String request = bottomBorder + " " + topBorder + " " + step;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
            ...
            for(int i = 0; i < rowNumber; i++)
           {
            if (jTable1.getValueAt(i, 1)!=null)
              {
                client.client(jTable1.getValueAt(i, 0).toString(),
                        jTable1.getValueAt(i, 1).toString(),
                        jTable1.getValueAt(i, 2).toString());
                
                res = client.getRes();
                jTable1.setValueAt(res,i, 3);
